# xorr on Base — the original build

This is the Base (ETHOnline 2026 · Base Build Camp) half of the project, moved here from the top-level README on
2026-09-19 when the repository became the Solana build. It describes the Base app, its contracts and its sponsors as
they were; nothing below applies to the Solana build.
