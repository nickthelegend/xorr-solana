...
export function useGrantDelegation() {
  ...
  return { grant, revoke, sendTransaction: send, estimateFee, busy, error, ready, walletStatus: undefined as string | undefined, walletError: undefined as string | undefined };
}
